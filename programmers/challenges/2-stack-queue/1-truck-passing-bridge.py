...
class Solution:
    def truck_passing_bridge(self, bridge_length: int, weight: int, truck_weights: List[int]):
        # 다리의 길이 만큼 0을 채워 넣음
...
if __name__ == '__main__':
    # print(Solution().truck_passing_bridge(2, 10, [7, 4, 5, 6]))
    print(Solution().truck_passing_bridge(100, 100, [10]))
