"""
url: https://programmers.co.kr/learn/courses/30/lessons/42885?language=python3
* 구명보트
...
def best_solution(people: List[int], limit: int) -> int:
    people.sort()
    count, left, right = 0, 0, len(people) - 1
...
def best_solution2(people: List[int], limit: int) -> int:
    answer = 0
    people.sort()
...
if __name__ == '__main__':
    ...
    print(best_solution(people, limit))
    print(best_solution2(people, limit))
